...
`define DATA_MEM_BW  31:0

// Memory size
`define INSTR_MEM_NUM 64
`define DATA_MEM_NUM  64
...
`define MALU_MUL    3'b000
`define MALU_MULH   3'b001
`define MALU_MULHSU 3'b010
`define MALU_MULHU  3'b011
`define MALU_DIV    3'b100
`define MALU_DIVU   3'b101
`define MALU_REM    3'b110
`define MALU_REMU   3'b111
